    ...
    <Card className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-2 gap-2">
        <label className="flex flex-col gap-1 text-xs text-cafe">
          ...
          <input
            ...
            className="rounded-lg border border-salvia bg-cream px-3 py-3 text-sm text-chocolate"
          />
        </label>
        <label className="flex flex-col gap-1 text-xs text-cafe">
          Weight (lb)
      ...
      <label className="flex flex-col gap-1 text-xs text-cafe">
        ...
        <select
          ...
          className="rounded-lg border border-salvia bg-cream px-3 py-3 text-sm text-chocolate capitalize"
        >
